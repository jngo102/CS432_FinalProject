class ObjModel extends Drawable {
    ...
    name = "";
    materialsMap = [];
    constructor(name, objPath, mtlPath, position = vec3(0, 0, 0), scale = 1, rotation = vec3(0, 0, 0), vshader="https://jngo102.github.io/CS432_FinalProject/shaders/vshader.glsl", fshader="https://jngo102.github.io/CS432_FinalProject/shaders/fshader.glsl") {
